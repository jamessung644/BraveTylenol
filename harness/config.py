...
class Settings(BaseSettings):
    ...
    log_level: Literal["DEBUG", "INFO", "WARNING", "ERROR"] = Field(default="INFO", validation_alias="HARNESS_LOG_LEVEL")
    max_tool_calls: int = Field(default=4, ge=1, le=12, validation_alias="MAX_TOOL_CALLS")
    l2_max_attempts: int = Field(default=3, ge=1, le=4, validation_alias="L2_MAX_ATTEMPTS")
